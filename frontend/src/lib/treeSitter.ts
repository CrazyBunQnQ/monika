...
// Get bare language name for a file extension (only valid after initTreeSitter completes)
export { extToLang }
// Asynchronously load a language by name (cached; waits for initTreeSitter automatically)
export { getLanguage }
// Wait for tree-sitter WASM runtime + grammars to be initialized
export { initPromise as treeSitterInitPromise }
